...
<%
	DivisionOffice dOffice = (DivisionOffice) request.getAttribute("office");
%>
...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
<td id="navigation"><a href="../../menu" target="_top" class="links">Main Menu</a> &gt; <a href="SearchDivisions.do" target="_top" class="links">Division List</a> &gt;<a href="ViewDivisionAndOffices.do?dOfficeID=<%=""+dOffice.getId()%>" target="_top" class="links">View Division</a> &gt; <em><strong>Add Office</strong></em></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="form_table">
