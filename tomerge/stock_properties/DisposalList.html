...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="#" target="_top" class="links">Stock Properties</a> &gt;<em><strong>Disposal List </strong></em>&gt; <a href="#" target="_self" class="links">Add Disposal</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
	...
	%>
    <tr>
      <td align="center" class="tablerow_1"><form id="form1" name="form1" method="post" action="EditDisposal.do">
        <input name="editBtn" type="submit" class="button2" id="editBtn" value="Edit&gt;&gt;" />
      <input type="hidden" name="disposalID"
		value=<%="" + d.getId()%> />
      </form></td>
      <td class="tablerow_1"><%=d.getName()%></td>
    </tr>
    <%
		i++;
		}
