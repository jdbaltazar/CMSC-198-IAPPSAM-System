...
<table width="100%" border="0">
  <tr>
    <td width="13%"><table width="100%" frame="below">
      <tr>
        <td style="font-family:Lucida Grande; font-size:20px; font-weight:bold; color:#003300"> View Division</td>
      </tr>
    </table></td>
    <td width="83%">&nbsp;</td>
...
<div id="apDiv12">
  ...
  <div id="apDiv16">
    <table width="100%" cellspacing="0" frame="box" class="tablerow_1">
      <tr>
        <td width="72%">&nbsp;</td>
        <td width="28%" align="center"><form id="form1" name="form1" method="post" action="">
          <input name="editBtn" type="submit" class="viewbutton" id="editBtn" value="Edit &gt;&gt;" />
        </form></td>
      </tr>
    </table>
  </div>
  ...
  <div id="apDiv18">
    <table width="100%" frame="box" cellspacing="0">
      <tr class="tablerow_1">
        <td width="72%">&nbsp;</td>
        <td width="28%" align="center"><form id="form3" name="form3" method="post" action="">
          <input name="editOfficeBtn" type="submit" class="viewbutton" id="editOfficeBtn" value="Edit &gt;&gt;" />
        </form></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
  ...
  <div id="apDiv21">
    <form id="form4" name="form4" method="post" action="">
      <input name="addNewOfficeBtn" type="submit" class="viewbutton" id="addNewOfficeBtn" value="Add New Office &gt;&gt;" />
    </form>
  </div>
