...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Employee` (
  ...
  `DivisionOffice_DivisionOffice_ID` INT NULL ,
  `Person_Person_ID` INT NOT NULL ,
  PRIMARY KEY (`Employee_ID`) ,
  INDEX `fk_Employee_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_Employee_Person1` (`Person_Person_ID` ASC) ,
  CONSTRAINT `fk_Employee_DivisionOffice1`
    FOREIGN KEY (`DivisionOffice_DivisionOffice_ID` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Contact` (
  ...
  `Contact_Type_Contact_Type` VARCHAR(45) NOT NULL ,
  `Supplier_ID` INT NULL ,
  `DivisionOffice_DivisionOffice_ID` INT NULL ,
  `Person_ID` INT NULL ,
  PRIMARY KEY (`Contact_ID`) ,
  INDEX `fk_Contact_Contact_Type1` (`Contact_Type_Contact_Type` ASC) ,
  INDEX `fk_Contact_Supplier1` (`Supplier_ID` ASC) ,
  INDEX `fk_Contact_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_Contact_Person1` (`Person_ID` ASC) ,
  CONSTRAINT `fk_Contact_Contact_Type1`
    FOREIGN KEY (`Contact_Type_Contact_Type` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Signatory` (
  ...
  INDEX `fk_Signatory_Employee2` (`Employee_Employee_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Purchase_Request` (
  ...
  `DivisionOffice_DivisionOffice_ID` INT NOT NULL ,
  ...
  `Signatory_Signatory_ID` INT NOT NULL ,
  `Signatory_Signatory_ID1` INT NOT NULL ,
  PRIMARY KEY (`Purchase_Request_ID`) ,
  INDEX `fk_Purchase_Request_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_Purchase_Request_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_Purchase_Request_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`PR_Line` (
  `PR_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `Quantity` INT NOT NULL ,
  `Unit_Unit` VARCHAR(20) NOT NULL ,
  `Item_Description` VARCHAR(500) NOT NULL ,
  `Stock_Number` VARCHAR(45) NULL ,
  `Estimated_Unit_Cost` DECIMAL(50,2) NULL ,
  `Purchase_Request_Purchase_Request_ID` INT NOT NULL ,
  PRIMARY KEY (`PR_Line_ID`, `Purchase_Request_Purchase_Request_ID`) ,
  INDEX `fk_PR_Line_Unit1` (`Unit_Unit` ASC) ,
  INDEX `fk_PR_Line_Purchase_Request1` (`Purchase_Request_Purchase_Request_ID` ASC) ,
  CONSTRAINT `fk_PR_Line_Unit1`
    FOREIGN KEY (`Unit_Unit` )
    REFERENCES `IAPPSAM`.`Unit` (`Unit` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_PR_Line_Purchase_Request1`
    FOREIGN KEY (`Purchase_Request_Purchase_Request_ID` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Item` (
  ...
  `Item_Status_Item_Status` VARCHAR(50) NOT NULL ,
  `Item_Condition_Item_Condition` VARCHAR(50) NOT NULL ,
  PRIMARY KEY (`Item_ID`) ,
  INDEX `fk_Item_Unit1` (`Unit_Unit` ASC) ,
  INDEX `fk_Item_Item_Status1` (`Item_Status_Item_Status` ASC) ,
  INDEX `fk_Item_Item_Condition1` (`Item_Condition_Item_Condition` ASC) ,
  ...
  CONSTRAINT `fk_Item_Item_Status1`
    FOREIGN KEY (`Item_Status_Item_Status` )
    REFERENCES `IAPPSAM`.`Item_Status` (`Item_Status` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Item_Item_Condition1`
    FOREIGN KEY (`Item_Condition_Item_Condition` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Purchase_Order` (
  ...
  `Date` DATE NOT NULL ,
  `Mode_Of_Procurement_Mode_Of_Procurement` VARCHAR(50) NOT NULL ,
  `DivisionOffice_DivisionOffice_ID` INT NOT NULL ,
  ...
  `Signatory_Signatory_ID` INT NOT NULL ,
  `Signatory_Signatory_ID1` INT NOT NULL ,
  `Signatory_Signatory_ID2` INT NOT NULL ,
  PRIMARY KEY (`PO_Number`) ,
  INDEX `fk_Purchase_Order_Supplier1` (`Supplier_Supplier_ID` ASC) ,
  INDEX `fk_Purchase_Order_Mode_Of_Procurement1` (`Mode_Of_Procurement_Mode_Of_Procurement` ASC) ,
  INDEX `fk_Purchase_Order_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_Purchase_Order_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_Purchase_Order_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
  INDEX `fk_Purchase_Order_Signatory3` (`Signatory_Signatory_ID2` ASC) ,
  ...
  CONSTRAINT `fk_Purchase_Order_Mode_Of_Procurement1`
    FOREIGN KEY (`Mode_Of_Procurement_Mode_Of_Procurement` )
  ...
  CONSTRAINT `fk_Purchase_Order_Signatory3`
    FOREIGN KEY (`Signatory_Signatory_ID2` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`PO_Line` (
  ...
  `Purchase_Order_PO_Number` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`PO_Line_ID`, `Purchase_Order_PO_Number`) ,
  INDEX `fk_PO_Line_Item1` (`Item_Item_ID` ASC) ,
  INDEX `fk_PO_Line_Purchase_Order1` (`Purchase_Order_PO_Number` ASC) ,
  ...
  CONSTRAINT `fk_PO_Line_Purchase_Order1`
    FOREIGN KEY (`Purchase_Order_PO_Number` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`PAR` (
  ...
  `Signatory_Signatory_ID1` INT NOT NULL ,
  PRIMARY KEY (`PAR_ID`) ,
  INDEX `fk_PAR_Supplier1` (`Supplier_Supplier_ID` ASC) ,
  INDEX `fk_PAR_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_PAR_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`PAR_Line` (
  `PAR_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `Item_Item_ID` INT NOT NULL ,
  `Property_Number` VARCHAR(45) NULL ,
  `PAR_PAR_ID` INT NOT NULL ,
  PRIMARY KEY (`PAR_Line_ID`, `PAR_PAR_ID`) ,
  INDEX `fk_PAR_Line_Item1` (`Item_Item_ID` ASC) ,
  INDEX `fk_PAR_Line_PAR1` (`PAR_PAR_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`ICS` (
  ...
  `Signatory_Signatory_ID1` INT NOT NULL ,
  PRIMARY KEY (`ICS_ID`) ,
  INDEX `fk_ICS_Number_Supplier1` (`Supplier_Supplier_ID` ASC) ,
  INDEX `fk_ICS_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_ICS_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`ICS_Line` (
  `ICS_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `Quantity` INT NOT NULL ,
  `Item_Item_ID` INT NOT NULL ,
  `Estimated_Useful_Life` INT NOT NULL ,
  `ICS_ICS_ID` INT NOT NULL ,
  PRIMARY KEY (`ICS_Line_ID`, `ICS_ICS_ID`) ,
  INDEX `fk_ICS_Line_ICS1` (`ICS_ICS_ID` ASC) ,
  INDEX `fk_ICS_Line_Item1` (`Item_Item_ID` ASC) ,
  CONSTRAINT `fk_ICS_Line_ICS1`
    FOREIGN KEY (`ICS_ICS_ID` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`PTRPA` (
  ...
  `DivisionOffice_DivisionOffice_ID` INT NOT NULL ,
  `DivisionOffice_DivisionOffice_ID1` INT NOT NULL ,
  `Signatory_Signatory_ID` INT NOT NULL ,
  `Signatory_Signatory_ID1` INT NOT NULL ,
  `Signatory_Signatory_ID2` INT NOT NULL ,
  PRIMARY KEY (`PTRPA_ID`) ,
  INDEX `fk_PTRPA_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_PTRPA_DivisionOffice2` (`DivisionOffice_DivisionOffice_ID1` ASC) ,
  INDEX `fk_PTRPA_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_PTRPA_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
  INDEX `fk_PTRPA_Signatory3` (`Signatory_Signatory_ID2` ASC) ,
  ...
  CONSTRAINT `fk_PTRPA_DivisionOffice2`
    FOREIGN KEY (`DivisionOffice_DivisionOffice_ID1` )
    REFERENCES `IAPPSAM`.`DivisionOffice` (`DivisionOffice_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`PTRPA_Line` (
  `PTRPA_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `ARE_MR_Number` VARCHAR(45) NULL ,
  `Item_Item_ID` INT NOT NULL ,
  `Quantity` INT NOT NULL ,
  `Remarks` VARCHAR(100) NULL ,
  `PTRPA_PTRPA_ID` INT NOT NULL ,
  PRIMARY KEY (`PTRPA_Line_ID`, `PTRPA_PTRPA_ID`) ,
  INDEX `fk_PTRPA_Line_Item1` (`Item_Item_ID` ASC) ,
  INDEX `fk_PTRPA_Line_PTRPA1` (`PTRPA_PTRPA_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Waste_Materials_Report` (
  ...
  `Signatory_Signatory_ID1` INT NOT NULL ,
  `Signatory_Signatory_ID2` INT NOT NULL ,
  `Signatory_Signatory_ID3` INT NOT NULL ,
  PRIMARY KEY (`Waste_Materials_Report_ID`) ,
  INDEX `fk_Waste_Materials_Report_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_Waste_Materials_Report_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_Waste_Materials_Report_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
  INDEX `fk_Waste_Materials_Report_Signatory3` (`Signatory_Signatory_ID2` ASC) ,
  INDEX `fk_Waste_Materials_Report_Signatory4` (`Signatory_Signatory_ID3` ASC) ,
  ...
  CONSTRAINT `fk_Waste_Materials_Report_Signatory4`
    FOREIGN KEY (`Signatory_Signatory_ID3` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `IAPPSAM`.`Disposal_Detail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `IAPPSAM`.`Disposal_Detail` ;

CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Disposal_Detail` (
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`WMR_Line` (
  `WMR_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `Quantity` INT NOT NULL ,
  `OR_Number` VARCHAR(60) NOT NULL ,
  `Disposal_Detail_ID` VARCHAR(80) NOT NULL ,
  `Waste_Materials_Report_ID` INT NOT NULL ,
  PRIMARY KEY (`WMR_Line_ID`, `Waste_Materials_Report_ID`) ,
  INDEX `fk_WMR_Line_Dispoasal_Type1` (`Disposal_Detail_ID` ASC) ,
  INDEX `fk_WMR_Line_Waste_Materials_Report1` (`Waste_Materials_Report_ID` ASC) ,
  CONSTRAINT `fk_WMR_Line_Dispoasal_Type1`
    FOREIGN KEY (`Disposal_Detail_ID` )
    REFERENCES `IAPPSAM`.`Disposal_Detail` (`Disposal` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`IIRUP` (
  ...
  INDEX `fk_IIRUP_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_IIRUP_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
  INDEX `fk_IIRUP_Signatory3` (`Signatory_Signatory_ID2` ASC) ,
  INDEX `fk_IIRUP_Signatory4` (`Signatory_Signatory_ID3` ASC) ,
  INDEX `fk_IIRUP_Employee1` (`Employee_Employee_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`IIRUP_Line` (
  ...
  `Accumulated_Depreciation` INT NOT NULL ,
  `Dispoasal_Type_Disposal_Type` VARCHAR(80) NOT NULL ,
  `Appraisal` VARCHAR(50) NULL ,
  `OR_Number` VARCHAR(45) NOT NULL ,
  `IIRUP_IIRUP_ID` INT NOT NULL ,
  PRIMARY KEY (`IIRUP_Line_ID`, `IIRUP_IIRUP_ID`) ,
  INDEX `fk_IIRUP_Line_Dispoasal_Type1` (`Dispoasal_Type_Disposal_Type` ASC) ,
  INDEX `fk_IIRUP_Line_IIRUP1` (`IIRUP_IIRUP_ID` ASC) ,
  CONSTRAINT `fk_IIRUP_Line_Dispoasal_Type1`
    FOREIGN KEY (`Dispoasal_Type_Disposal_Type` )
    REFERENCES `IAPPSAM`.`Disposal_Detail` (`Disposal` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_IIRUP_Line_IIRUP1`
    FOREIGN KEY (`IIRUP_IIRUP_ID` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`APP` (
  ...
  `Signatory_Signatory_ID1` INT NOT NULL ,
  PRIMARY KEY (`APP_ID`) ,
  INDEX `fk_APP_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_APP_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`APP_Line` (
  ...
  `APP_APP_ID` INT NOT NULL ,
  PRIMARY KEY (`APP_Line_ID`, `APP_APP_ID`) ,
  INDEX `fk_APP_Line_APP1` (`APP_APP_ID` ASC) ,
  INDEX `fk_APP_Line_Item1` (`Item_Item_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Inventory_Of_Equipment` (
  ...
  `Signatory_Signatory_ID` INT NOT NULL ,
  `Signatory_Signatory_ID1` INT NOT NULL ,
  `Signatory_Signatory_ID2` INT NULL ,
  `Signatory_Signatory_ID3` INT NULL ,
  `Signatory_Signatory_ID4` INT NOT NULL ,
  `Signatory_Signatory_ID5` INT NOT NULL ,
  `Signatory_Signatory_ID6` INT NULL ,
  PRIMARY KEY (`Inventory_Of_Equipment_ID`) ,
  INDEX `fk_Inventory_Of_Equipment_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_Inventory_Of_Equipment_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_Inventory_Of_Equipment_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
  INDEX `fk_Inventory_Of_Equipment_Signatory3` (`Signatory_Signatory_ID2` ASC) ,
  INDEX `fk_Inventory_Of_Equipment_Signatory4` (`Signatory_Signatory_ID3` ASC) ,
  INDEX `fk_Inventory_Of_Equipment_Signatory5` (`Signatory_Signatory_ID4` ASC) ,
  INDEX `fk_Inventory_Of_Equipment_Signatory6` (`Signatory_Signatory_ID5` ASC) ,
  INDEX `fk_Inventory_Of_Equipment_Signatory7` (`Signatory_Signatory_ID6` ASC) ,
  CONSTRAINT `fk_Inventory_Of_Equipment_DivisionOffice1`
    FOREIGN KEY (`DivisionOffice_DivisionOffice_ID` )
    REFERENCES `IAPPSAM`.`DivisionOffice` (`DivisionOffice_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventory_Of_Equipment_Signatory1`
    FOREIGN KEY (`Signatory_Signatory_ID` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventory_Of_Equipment_Signatory2`
    FOREIGN KEY (`Signatory_Signatory_ID1` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventory_Of_Equipment_Signatory3`
    FOREIGN KEY (`Signatory_Signatory_ID2` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventory_Of_Equipment_Signatory4`
    FOREIGN KEY (`Signatory_Signatory_ID3` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventory_Of_Equipment_Signatory5`
    FOREIGN KEY (`Signatory_Signatory_ID4` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventory_Of_Equipment_Signatory6`
    FOREIGN KEY (`Signatory_Signatory_ID5` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Inventory_Of_Equipment_Signatory7`
    FOREIGN KEY (`Signatory_Signatory_ID6` )
    REFERENCES `IAPPSAM`.`Signatory` (`Signatory_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`IE_Line` (
  `IE_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `Quantity` INT NOT NULL ,
  `Year_Acquired` YEAR NULL ,
  `Employee_Employee_ID` INT NOT NULL ,
  `How_Acquired` VARCHAR(100) NOT NULL ,
  `Remarks` VARCHAR(100) NULL ,
  `Inventory_Of_Equipment_Inventory_Of_Equipment_ID` INT NOT NULL ,
  PRIMARY KEY (`IE_Line_ID`, `Inventory_Of_Equipment_Inventory_Of_Equipment_ID`) ,
  INDEX `fk_IE_Line_Inventory_Of_Equipment1` (`Inventory_Of_Equipment_Inventory_Of_Equipment_ID` ASC) ,
  INDEX `fk_IE_Line_Employee1` (`Employee_Employee_ID` ASC) ,
  CONSTRAINT `fk_IE_Line_Inventory_Of_Equipment1`
    FOREIGN KEY (`Inventory_Of_Equipment_Inventory_Of_Equipment_ID` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Requisition_And_Issue_Slip` (
  ...
  INDEX `fk_Requisition_And_Issue_Slip_DivisionOffice1` (`DivisionOffice_DivisionOffice_ID` ASC) ,
  INDEX `fk_Requisition_And_Issue_Slip_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_Requisition_And_Issue_Slip_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
  INDEX `fk_Requisition_And_Issue_Slip_Signatory3` (`Signatory_Signatory_ID2` ASC) ,
  INDEX `fk_Requisition_And_Issue_Slip_Signatory4` (`Signatory_Signatory_ID3` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`RIS_Line` (
  `RIS_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `Item_Item_ID` INT NOT NULL ,
  `Quantity_Requested` INT NOT NULL ,
  `Quantity_Issued` INT NOT NULL ,
  `Remarks` VARCHAR(200) NULL ,
  `Requisition_And_Issue_Slip_RIS_Number` INT NOT NULL ,
  PRIMARY KEY (`RIS_Line_ID`, `Requisition_And_Issue_Slip_RIS_Number`) ,
  INDEX `fk_RIS_Line_Item1` (`Item_Item_ID` ASC) ,
  INDEX `fk_RIS_Line_Requisition_And_Issue_Slip1` (`Requisition_And_Issue_Slip_RIS_Number` ASC) ,
  ...
  CONSTRAINT `fk_RIS_Line_Requisition_And_Issue_Slip1`
    FOREIGN KEY (`Requisition_And_Issue_Slip_RIS_Number` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`RSMI` (
  ...
  `Signatory_Signatory_ID1` INT NOT NULL ,
  PRIMARY KEY (`RSMI_ID`) ,
  INDEX `fk_RSMI_Signatory1` (`Signatory_Signatory_ID` ASC) ,
  INDEX `fk_RSMI_Signatory2` (`Signatory_Signatory_ID1` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`RSMI_Line` (
  `RSMI_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `RIS_Line_RIS_Line_ID` INT NOT NULL ,
  `Responsibility_Center` VARCHAR(80) NULL ,
  `RSMI_RSMI_ID` INT NOT NULL ,
  PRIMARY KEY (`RSMI_Line_ID`, `RSMI_RSMI_ID`) ,
  INDEX `fk_RSMI_Line_RIS_Line1` (`RIS_Line_RIS_Line_ID` ASC) ,
  INDEX `fk_RSMI_Line_RSMI1` (`RSMI_RSMI_ID` ASC) ,
  CONSTRAINT `fk_RSMI_Line_RIS_Line1`
    FOREIGN KEY (`RIS_Line_RIS_Line_ID` )
    REFERENCES `IAPPSAM`.`RIS_Line` (`RIS_Line_ID` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_RSMI_Line_RSMI1`
    FOREIGN KEY (`RSMI_RSMI_ID` )
...
CREATE  TABLE IF NOT EXISTS `IAPPSAM`.`Recapitulation_Line` (
  `Recapitulation_Line_ID` INT NOT NULL AUTO_INCREMENT ,
  `Item_Item_ID` INT NOT NULL ,
  `Quantity` INT NOT NULL ,
  `Account_Code` VARCHAR(45) NOT NULL ,
  `RSMI_RSMI_ID` INT NOT NULL ,
  PRIMARY KEY (`Recapitulation_Line_ID`, `RSMI_RSMI_ID`) ,
  INDEX `fk_Recapitulation_Line_RSMI1` (`RSMI_RSMI_ID` ASC) ,
  INDEX `fk_Recapitulation_Line_Item1` (`Item_Item_ID` ASC) ,
