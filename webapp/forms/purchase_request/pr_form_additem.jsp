...
<table width="100%" border="0">
	<tr>
		...
		<td width="80%">&nbsp;</td>
		<td width="7%">
		<form id="form15" name="form15" method="post" action="pr_form_2.jsp"><input
...
<form id="form2" name="form2" method="post" action="pr_imbed_items.do">

<div id="apDiv1"><input name="addAllBtn" type="submit"
	class="maroon" id="addAllBtn" value="Add Selected Items &gt;&gt;" /></div>
...
<form id="form1" name="form1" method="get"
	action="search_pr_item_list.do"><label for="searchItemField"
...
<div id="apDiv10"
	style="font-family: Lucida Grande; font-size: 10px; color: red;"><em>Item
Not Found?</em></div>
<p>&nbsp;</p>
<div id="apDiv11">
<form id="form3" name="form3" method="post" action=""><input
	name="addNewItem" type="submit" class="maroon" id="addNewItem"
	value="Add New &gt;&gt;" /></form>
</div>
</body>
</html>
