...
<div id="designationDiv">
  <form id="form3" name="form3" method="post" action="../accounts/accountCreate.do">
...
<div id="empNumDiv">
  <form id="form4" name="form4" method="post" action="">
    <label for="employeeNumber" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">Employee Num:</label>
...
<div id="Division">
  <form id="form5" name="form5" method="post" action="">
    <label for="division" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">Division:</label>
...
<div id="officeDiv">
  <form id="form6" name="form6" method="post" action="">
    <label for="office" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">Office:</label>
...
<div id="passwordDiv">
  <div>
    <form id="form8" name="form8" method="post" action="">
      <label for="password" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">*Password:</label>
...
<div id="sumbmitDivBtn">
  <form id="form10" name="form10" method="post" action="../MenuFrame.html">
    <p>
      <input type="submit" name="submit" id="submit" value="Back" style="background-color:#7B1113;color:white;font-family:Lucida Grande;font-size:20px;"/>
    </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
  </form>
...
<div id="apDiv4">
  <form id="form11" name="form11" method="post" action="">
    <label for="mobileNumber" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">Cellphone Number:</label>
...
<div id="apDiv5">
  <form id="form12" name="form12" method="post" action="">
    <label for="landline" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">Landline:</label>
...
<div id="apDiv6">
  <form id="form13" name="form13" method="post" action="">
    <label for="emailad" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">E-mail Address:</label>
...
<div id="acctTypediv">
  <form id="form14" name="form14" method="post" action="">
    <label for="acctType" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">*Account Type: </label>
