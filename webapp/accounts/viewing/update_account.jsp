...
<input name="personID" type="hidden"
	value="<%if (account != null)
				out.print(account.getPerson().getId());

			else
				request.getRequestDispatcher("error.jsp").forward(request,
						response);%>" />
<input name="userName" type="hidden" value="<%=account.getUsername()%>" />
<input name="addWorkInfoBtn" type="submit" class="addbtn"
	id="addWorkInfoBtn" title="Click to view work info."
	value="Work Information &gt;&gt;" /></form>
</div>
<div id="apDiv24">
...
<form id="form1" name="form1"
	method="<%String isFinished = (String) request.getAttribute("isFinished");
			if (isFinished == null)
				out.print("get");
			else
				out.print("post");%>"
	action="update_account.do"><input type="hidden" name="userName"
	value="<%if (account != null)
...
<input name="title" type="text" id="title2" size="20"
...
<input name="name" type="text" id="name" size="40"
	value="<%if (account != null)
				out.print(account.getPerson().getName());
			else
				request.getRequestDispatcher("error.jsp").forward(request,
						response);%>" /></div>
<p>&nbsp;</p>
...
<div id="apDiv17"><label for="password3"
	style="font-family: Lucida Grande; font-size: 16px; font-weight: bold">*New
Password:</label> <input name="password" type="password" id="password3"
	size="30"
...
<input name="oldPassword" type="password" id="oldPassword" size="30" />
<%
	String passwordTrue = (String) request.getAttribute("passwordTrue");
	if (passwordTrue != null && !passwordTrue.isEmpty()
			&& passwordTrue.equalsIgnoreCase("false")) {
		out.print("*Invalid Input");
	}
%>
</div>
