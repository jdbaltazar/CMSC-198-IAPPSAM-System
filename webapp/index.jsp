...
<form id="form1" name="form1" method="post" action="login">
			<div class="login-layout">
				<label style="font-family:Lucida Grande; font-size:14px">Username</label> <input name="username" type="text" id="username" size="25" />
				
				<p>
					<label style="font-family:Lucida Grande; font-size:14px"> Password</label> <input name="password" type="password" id="password2" size="25"/>
					<%
		...
		<div class="important">
			<p>
				<span class="important-text">Important:</span> <br /> 
				<span class="important-message"> *USERNAME and PASSWORD ARE CASE-SENSITIVE.<br /> 
				*DO NOT FORGET
					TO LOGOUT YOUR ACCOUNT ONCE YOU COMPLETED YOUR SESSION. </span>
			</p>
		</div>
...
<p>
			...
			completion and validation of processes that can span across multiple other departments/ offices in UPVTC. <br /> 
			<br />
			<br /> Please type the Username
