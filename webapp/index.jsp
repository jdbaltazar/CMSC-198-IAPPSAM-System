...
<form name="LoginForm" method="post" action="login">
  <table width="95%" border="0" cellspacing="0" id="logintable">
    <tr>
      <td><div style="font-family:Lucida Grande; color:black; font-size:12px; margin-left:15px"><p>IAPPSAMS is a web-based database system that keeps records for  the UPVTC Supply and Property  Services Office (SPSO)  and shall facilitate convenient completion and validation of processes that can span across multiple other departments/ offices in UPVTC.
    <br />
    <br />
  </p>
          ...
          <td><table width="100%" border="0" cellspacing="0">
            ...
            <tr>
              <td colspan="2" align="center"><br />
                <input name="enterBtn" type="submit" class="button" id="enterBtn" value="Enter" />
                <br />
                <br /></td>
              </tr>
            <tr>
              <td id="importantNotice"><div class="importantNotice">Important:</div></td>
              <td>&nbsp;</td>
              </tr>
            <tr>
              <td colspan="2" id="notice">
                <div class="notice">*USERNAME and PASSWORD ARE CASE-SENSITIVE.<br />
*DO NOT FORGET TO LOGOUT YOUR ACCOUNT ONCE YOU COMPLETED YOUR SESSION.<br />                
<br />
                </div></td>
              </tr>
            </table></td>
