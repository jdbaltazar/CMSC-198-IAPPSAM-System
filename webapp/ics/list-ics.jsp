...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="#" target="_top" class="links">Main Menu</a> &gt;<em><strong>ICS List </strong></em>&gt; <a href="#" target="_self" class="links">Fillup ICS Form</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="42%" class="tableheaders_forms">Received by</td>
      <td width="38%" class="tableheaders_forms">Received from</td>
    </tr>
	<tr>
