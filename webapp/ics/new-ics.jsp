...
<title>IAPPSAM::Fillup ICS</title>
...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="#" target="_top" class="links">Main Menu</a> &gt; <a href="#" target="_top" class="links">ICS List</a> &gt; <em><strong>Fillup ICS</strong></em><strong></strong></td>
    <td>&nbsp;</td>
  </tr>
</table>
    ...
    <table width="100%" border="0" cellspacing="0">
      <tr>
        <td colspan="2"><table width="100%" border="0" cellspacing="0" class="tableheaders_forms">
          <tr>
            ...
            <td>Estimated Useful Life (in years)</td>
          </tr>
          <tr class="tablerow_1">
            <td>&nbsp;</td>
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><label for="estUsefulLife"></label>
            <input name="estUsefulLife" type="text" class="required" id="estUsefulLife" size="2" /></td>
          </tr>
      ...
      <tr>
        <td colspan="2"><table width="25%" border="0" align="center" cellspacing="0">
          <tr>
            <td class="other_fields_label">ICS No.:</td>
            <td class="right_side_table"><input type="text" name="icsNum" id="icsNum" /></td>
            </tr>
          <tr>
