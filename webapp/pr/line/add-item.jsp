...
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
    <tr>
      <td colspan="3" align="center"><form id="form4" name="form4" method="post" action="">
    ...
    <tr>
      <td colspan="3"><table width="100%" border="0" cellspacing="6">
        <tr>
          <td align="center"><span class="importantNotice"><em>Item Not Found?</em></span>            
          <form id="form3" name="form3" method="get" action="/items">
			<input type="hidden" name="new" value="item" />
			 <input name="NewItemButton" type="submit" class="smallbutton" id="addNewItem" value="Add New>>" />
		</form></td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr>
      <td width="7%" class="tableheaders_forms"><input type="checkbox" name="selectAll" id="selectAll" /></td>
    ...
    <c:forEach var="item" items="${items}">
		...
		<tr>
          <td><input name="add" type="submit" class="smallbutton" id="addAllBtn" value="Add Selected Items&gt;&gt;" /></td>
        </tr>				
	</form>
