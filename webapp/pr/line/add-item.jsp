	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="/menu" target="_top" class="links">Main
				...
				href="../pr?new=pr&retain=retain" class="links">Fillup PR</a>
			</td>
		...
		<table width="100%" border="0" cellspacing="0">
			...
			<tr>
				<td colspan="3" align="center"><form id="form4" name="form4"
						method="post" action="">
						<label for="q"><span class="align_right">Search</span>:</label> <input
							type="text" name="q" id="q" value="<%=q%>" /> <input name="goBtn"
							type="submit" class="button" id="goBtn" value="GO" />
					</form></td>
			</tr>
			<tr>
