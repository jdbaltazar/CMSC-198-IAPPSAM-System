...
Request List</a> > <a href="/pr?new=pr">New Purchase Request</a></div>
<div id="Title" class="Form"></div>
<form id="form1" name="form1" method="post" action="/pr">
<div id="PageHeader" class="Form"><!-- Division Office --> <label
	for="deptAndSection" class="labels">Department &amp; Section: </label>
...
<!-- PR --> <label for="prNumber" class="labels">PR.No.:</label> <input
	type="text" name="prNumber" id="PrNumber" size="15" maxlength="15"
	value="${form.prNumber}" /> <label for="prdate" class="labels">Date:</label>
<input type="text" name="prDate" id="prDate" value="${form.prDate}" />
<br />
<!-- SAI --> <label for="saiNumber" class="labels">SAI No.:</label> <input
	name="saiNumber" type="text" id="saiNumber" size="15" maxlength="15"
	value="${form.saiNumber}" /> <label for="saiDate" class="labels">Date:</label>
<input type="text" name="saiDate" id="saiDate" value="${form.saiDate}" />
<br />
<!-- ALOBS --> <label for="alobsNumber" class="labels">ALOBS
No.:</label> <input name="alobsNumber" type="text" id="alobsNumber" size="15"
	maxlength="15" value="${form.alobsNumber}" /> <label for="alobsDate"
	class="labels">Date:</label> <input name="alobsDate" type="text"
	id="alobsDate" value="${form.alobsDate}" /></div>
<div id="line">
	...
	<c:forEach var="line" items="${form.lines}" varStatus="loop">
		<tr>
			...
			<td width="5%"><input name="quantity" type="text"
				class="textfields_1" id="Quantity" size="4" value="${line.quantity}" /></td>
...
<div id="LineAction" class="Form"><input type="submit"
	name="addItems" id="additem" value="Add Items" /> <input type="submit"
	name="removeItems" id="removeItem" value="Remove Items" /></div>
<div id="PageFooter" class="Form"><label for="purpose"
	class="labels">Purpose:</label> <textarea name="purpose" id="purpose">${form.purpose}</textarea>
<br />
<label for="requestedBy" class="labels">Requested by:</label> <select
...
</select> <label for="approvedby" class="labels">Approved by:</label> <select
