			...
			<table width="100%" border="0" cellspacing="0">
						...
						<table width="25%" border="0" align="center" cellspacing="0">
							...
							<tr>
								...
								<td class="right_side_table"><input type="text"
									...
									value="${form.prNumber}" /></td>
							</tr>
							<tr>
								<td class="other_fields_label">Date:</td>
								<td class="right_side_table"><input type="text"
									name="prDate" id="prDate" value="${form.prDate}" /></td>
							</tr>
							<tr>
								...
								<td class="right_side_table"><input name="saiNumber"
									...
									value="${form.saiNumber}" /></td>
							</tr>
							<tr>
								<td class="other_fields_label">Date:</td>
								<td class="right_side_table"><input type="text"
									name="saiDate" id="saiDate" value="${form.saiDate}" /></td>
							</tr>
							<tr>
				...
				<tr>
					<td colspan="2" align="center"><br /> <input type="submit"
						name="saveForm" class="button" value="SUBMIT Form" /></td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>
				</tr>
