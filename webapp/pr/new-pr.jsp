...
<script>
	...
	function checkAll() {
		if (document.PRForm.all.checked == true) {
			for ( var i = 0; i < document.PRForm.checkedItems.length; i++) {
				document.PRForm.checkedItems[i].checked = true;
			}
		} else {
			for ( var i = 0; i < document.PRForm.checkedItems.length; i++) {
				document.PRForm.checkedItems[i].checked = false;
			}
		}
	}
</script>
	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="/menu" target="_top" class="links">Main
				...
				&gt; <em><strong>Fillup Purchase Request</strong> </em><strong></strong>
			</td>
			<td>&nbsp;</td>
		</tr>
	</table>
			...
			<table width="100%" border="0" cellspacing="0">
					...
					<td colspan="2">
						<table width="100%" border="0" cellspacing="0">
							...
							<c:forEach var="line" items="${form.lines}" varStatus="loop">
								<tr class="tablerow_1">
									<td width="2%"><input type="checkbox" name="checkedItems"
										id="items" value="${line.item.id}" /> <input type="hidden"
										name="items" value="${line.item.id}" />
									</td>
				...
				<tr>
					<td width="50%" align="right" class="same_width"><br /> <input
						type="submit" name="addItems" id="additem" class="button"
						value="Add Item&gt;&gt;" /> <br /></td>
					<td align="left" class="same_width">
						<p>
							<br /> <input type="submit" name="removeItems" id="removeItem"
								class="button" value="Remove Item" />
						</p></td>
				</tr>
				<tr>
					<td colspan="2">
						<table width="25%" border="0" align="center" cellspacing="0">
							...
							<tr>
								...
								<td class="right_side_table"><input type="text"
									name="prNumber" id="PrNumber" maxlength="45"
									value="${form.prNumber}" />
								</td>
							</tr>
							<tr>
								...
								<td class="right_side_table"><input type="text"
									name="prDate" id="prDate" value="${form.prDate}" />
								</td>
							</tr>
							<tr>
								...
								<td class="right_side_table"><input name="saiNumber"
									type="text" id="saiNumber" maxlength="45"
									value="${form.saiNumber}" />
								</td>
							</tr>
							<tr>
								<td class="other_fields_label">Date:</td>
								<td class="right_side_table"><input type="text"
									name="saiDate" id="saiDate" value="${form.saiDate}" />
								</td>
							</tr>
							<tr>
				...
				<tr>
					<td colspan="2" align="center"><br /> <input type="submit"
						name="saveForm" class="button" value="SUBMIT Form" />
					</td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>
