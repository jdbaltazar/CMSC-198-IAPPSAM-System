...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="../../menu" target="_top" class="links">Main Menu</a> &gt;<em><strong>Item List </strong></em>&gt; <a href="/items?new=item" target="_self" class="links">Add Item</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
    <tr>
      <td colspan="5" align="center"><form id="form4" name="form4" method="get" action="/items">
        <label for="searchField" class="align_right">Search:</label>
        <input type="text" name="q" id="searchField" />
        <input name="search" type="submit" class="button" id="goBtn" value="GO" />
      </form></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
