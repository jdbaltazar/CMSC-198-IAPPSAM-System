...
<body>
	...
	<div id="createNewAcctDiv">
		<form id="form1" name="form1" method="post"
			action="accounts/CreateAccount.html">
	...
	<div id="itemDiv">
		<form id="form5" name="form5" method="post"
			action="stocks/items/SearchItems.html">
	...
	<div id="fillupDiv">
		<form id="form8" name="form8" method="get"
			action="forms/FormsMenuPage.html">
	...
	<div id="divisionOfficeDiv">
		<form id="form13" name="form13" method="post"
			action="entities/division/ViewDivisionBldgOffice.html">
			<input name="divisionOfficeBtn" type="submit" class="button2"
				id="divisionOfficeBtn" value="Building/Division/Office" />
		</form>
	</div>
	<div id="employeeDiv">
		<form id="form14" name="form14" method="post"
			action="entities/employees/SearchEmployee.html">
	...
	<div id="apDiv2">
		<form id="form12" name="form12" method="post" action=""LogIn.do"">
