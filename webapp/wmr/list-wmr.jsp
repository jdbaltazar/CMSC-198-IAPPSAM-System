...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="#" target="_top" class="links">Main Menu</a> &gt;<em><strong>WMR List </strong></em>&gt; <a href="#" target="_self" class="links">Fillup WMR Form</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="42%" class="tableheaders_forms">Property Officer</td>
      <td width="38%" class="tableheaders_forms">Property Inspector</td>
    </tr>
	<tr>
