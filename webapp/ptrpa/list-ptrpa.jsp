...
<title>IAPPSAM::PTRPA List</title>
...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="#" target="_top" class="links">Main Menu</a> &gt;<em><strong>PTRPA List </strong></em>&gt; <a href="#" target="_self" class="links">Fillup PTRPA Form</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
    <tr>
      <td colspan="5" align="center"><form id="form1" name="form1" method="post" action="">
    ...
    <tr>
      <td width="10%" class="tableheaders_forms">Date</td>
      <td width="21%" class="tableheaders_forms">From</td>
      <td width="21%" class="tableheaders_forms">To</td>
      <td width="24%" class="tableheaders_forms">Transferred by</td>
      <td width="24%" class="tableheaders_forms">Accepted by</td>
    </tr>
	<tr>
