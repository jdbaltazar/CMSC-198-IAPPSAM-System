...
<%
	...
	if (!((String)request.getAttribute("designationIsOK")).equalsIgnoreCase("true"))
		out.print("*");
	else
		out.print("");
%></p>
...
Num</label> <input type="text" name="employeeNumber" id="employeeNumber2" /></p>
...
</label> <input name="userName" type="text" id="userName" size="35" />
<%
	if (!((String)request.getAttribute("usernameIsOK")).equalsIgnoreCase("true"))
		out.print("*");
	else
		out.print("");
%>
...
<%
	...
	if (!((String)request.getAttribute("passIsOK")).equalsIgnoreCase("true"))
		out.print("*");
	else
		out.print("");
%></p>
<p><label for="reenterPassword2"
...
<%
	...
	if (!((String)request.getAttribute("nameIsOK")).equalsIgnoreCase("true"))
		out.print("*");
	else
		out.print("");
%><br />
