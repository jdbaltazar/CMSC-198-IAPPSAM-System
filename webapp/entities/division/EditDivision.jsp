...
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		<td id="navigation"><a href="../../menu" target="_top"
			...
			href="SearchDivisions.do"
			target="_top" class="links">Division List</a> &gt; <a
			href="ViewDivisionAndOffices.do?dOfficeID=<%=""+dOffice.getId()%>" target="_top" class="links">View
		Division</a> &gt; <em><strong>Edit Division</strong></em></td>
		<td>&nbsp;</td>
	</tr>
</table>
<div id="form_table">
		...
		<table width="100%" cellspacing="0" frame="box" id="table">
			...
			<tr>
				...
				<td><input name="saveBtn" type="submit" class="button"
					id="saveBtn" value="SAVE" /> <input type="hidden" name="dOfficeID"
					value=<%="" + dOffice.getId()%> /> <br />
				<br />
				</td>
			</tr>
		</table>
