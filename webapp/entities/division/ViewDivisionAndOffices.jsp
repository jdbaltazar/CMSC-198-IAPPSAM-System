...
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		...
		Menu</a> &gt; <a href="SearchDivisions.do" target="_top" class="links">Division List</a>
		&gt; <em><strong>View Division</strong></em></td>
		<td>&nbsp;</td>
	</tr>
</table>
<div id="form_table">
<table width="100%" border="0" cellspacing="0">
	...
	<tr class="tablerow_1">
		...
		<td>
		<form id="form4" name="form4" method="post" action="EditDivision.do">
		<input name="editDivisionBtn" type="submit" class="button2"
			id="editDivisionBtn" value="Edit&gt;&gt;" /> <input type="hidden"
			name="dOfficeID" value=<%="" + dOffice.getId()%> /></form>
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td>
		<form id="form1" name="form1" method="post" action="AddOffice.do"><input
			name="addOfficeBtn" type="submit" class="button" id="addOfficeBtn"
			value="Add Office&gt;&gt;" />
			<input type="hidden" name="dOfficeID" value="<%=""+dOffice.getId()%>"/>
			</form>
		</td>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0">
			...
			>
				...
				<td>
				<form id="form3" name="form3" method="post" action="EditOffice.do">
