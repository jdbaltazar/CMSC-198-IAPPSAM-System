...
<div class="headers" id="apDiv19"><%=office.getDivisionName()%></div>
<div class="tablerow_1" id="apDiv24"></div>
<div id="apDiv25">
<form id="form1" name="form1" method="post" action="SaveOfficeEdit.do">
<p>&nbsp;</p>
<div id="apDiv26"><label for="newName" class="labels">New
Name:</label> <input name="newName" type="text" id="newName"
	value="<%=office.getOfficeName()%>" maxlength="80" /></div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<div id="apDiv27"><input type="submit" name="updateBtn"
	id="updateBtn"
	style="background-color: #7B1113; color: white; font-family: Lucida Grande; font-size: 20px;"
	value="Update" /></div>
<p>&nbsp;</p>
<input type="hidden" name="officeID" value=<%="" + office.getId()%>></input>
</form>
</div>
