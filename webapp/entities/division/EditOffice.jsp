	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="menu" target="_top" class="links">Main
				...
				href="division-office?division-office-action=view-offices&dOfficeID=<%="" + office.getId()%>"
					...
					<td>
						<table width="100%" cellspacing="0" frame="box" id="table">
							<tr>
								...
								<td><br /> <input name="newName" type="text"
									class="required" id="newName"
									value="<%=office.getOfficeName()%>" maxlength="80" /> <input
									type="hidden" name="officeID" value=<%="" + office.getId()%>></input>
									<br /> <br /></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input name="saveBtn" type="submit" class="button"
									...
									<input name="division-office-action" type="hidden" value="save-edited-office"/>
									<br /> <br /></td>
							</tr>
						</table></td>
				</tr>
