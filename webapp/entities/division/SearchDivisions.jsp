...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="../../menu" target="_top" class="links">Main Menu</a> &gt;<em><strong>Division List </strong></em>&gt; <a href="AddDivision.jsp" target="_self" class="links">Add Division</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
