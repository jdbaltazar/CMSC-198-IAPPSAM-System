...
<table width="100%" border="0">
  <tr>
    ...
    <td width="85%">&nbsp;</td>
    <td width="4%"><form id="form15" name="form15" method="post" action="SearchItems.html">
...
<div id="searchEmployeesDiv">
  <form id="form1" name="form1" method="post" action="">
    <label for="searchEmployeeField" class="labels">Search:</label>
    <input name="searchEmployeeField" type="text" id="searchEmployeeField" size="35" />
    <input name="goSearchBtn" type="submit" class="maroon" id="goSearchBtn" value="GO" />
  </form>
</div>
<div id="apDiv1">
  <form id="form2" name="form2" method="post" action="AddEmployee.html">
    <input name="addEmployeeBtn" type="submit" class="maroon" id="addEmployeeBtn" value="Add Employee &gt;&gt;" />
  </form>
</div>
<div id="apDiv10">
