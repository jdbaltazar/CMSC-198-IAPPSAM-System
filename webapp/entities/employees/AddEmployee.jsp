...
<%@page import="com.iappsam.managers.sessions.DivisionOfficeManagerSession"%>
...
<select name="division" id="division3">
	<%	DivisionOfficeManager doManager = new DivisionOfficeManagerSession();
		List<DivisionOffice> dOffice = doManager
	...
	<%
		out.print(dOffice.get(i).getDivisionName());
			if (dOffice.get(i).getOfficeName() == "null")
