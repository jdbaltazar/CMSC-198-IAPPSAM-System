	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="menu" target="_top" class="links">Main
					Menu</a> &gt;<em><strong>Building List </strong> </em>&gt; <a
				href="building?building-action=add-building" target="_self"
				class="links">Add Building</a></td>
			<td>&nbsp;</td>
		</tr>
	</table>
	<div id="items_table">
		<table width="100%" border="0" cellspacing="0">
			...
			<tr>
				<td align="center"
					...
					<form id="form1" name="form1" method="get" action="building">
						<input name="editBtn" type="submit" class="button2" id="editBtn"
							value="Edit&gt;&gt;" /> <input name="buildingID" type="hidden"
							value="<%=b.getId()%>" /> <input name="building-action"
							type="hidden" value="edit-building" />
					</form>
				</td>
				<td align="center"
					<%if (i % 2 == 0)
					...
					out.println("class=\"tablerow_2\"");%>><%=b.getName()%></td>
			</tr>
