...
<form id="form1" name="form1" method="post"
	action="SaveEditedBuilding.do">
<p><label for="name"
	style="font-family: Lucida Grande; font-size: 16px; font-weight: bold">*Name:</label>
<input name="name" type="text" id="name"
	value="<%=building.getBuildingName()%>" size="30" maxlength="80" /></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<div id="apDiv8"><label for="address"
	style="font-family: Lucida Grande; font-size: 16px; font-weight: bold">Address:</label>
<input name="address" type="text" id="address"
	value="<%=building.getBuildingAddress()%>" size="30" maxlength="200" />
</div>
<p>&nbsp;</p>
<div id="apDiv9"><input type="submit" name="addBtn" id="addBtn"
...
<form id="form3" name="form3" method="post" action=""><em>*required
field</em></form>
</div>
<div id="footer"></div>
<p>&nbsp;</p>
