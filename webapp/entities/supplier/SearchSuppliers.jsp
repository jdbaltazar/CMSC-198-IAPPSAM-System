...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="menu" target="_top" class="links">Main Menu</a> &gt;<em><strong>Supplier List </strong></em>&gt; <a href="supplier?supplier-action=new-supplier" target="_self" class="links">Add Supplier</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
    <tr>
      <td colspan="4" align="center"><form id="form4" name="form4" method="post" action="">
    ...
    <tr>
      <td align="center" <%if (i % 2 == 0)
					out.print("class=\"tablerow_1\"");%>><form id="form1" name="form1" method="get" action="supplier">
        <input name="editBtn" type="submit" class="button2" id="editBtn" value="View&gt;&gt;" />
        <input type="hidden" name="supplier-action" value="view-supplier" /> 
