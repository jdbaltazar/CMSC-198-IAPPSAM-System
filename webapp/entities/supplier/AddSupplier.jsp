...
<table width="100%" border="0">
  <tr>
    <td width="12%"><table width="100%" frame="below">
      <tr>
        <td style="font-family:Lucida Grande; font-size:20px; font-weight:bold; color:#003300">Add Supplier</td>
      </tr>
    </table></td>
    <td width="84%">&nbsp;</td>
    <td width="4%"><form id="form15" name="form15" method="post" action="SearchEmployee.html">
