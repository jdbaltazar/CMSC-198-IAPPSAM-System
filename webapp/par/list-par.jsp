...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="#" target="_top" class="links">Main Menu</a> &gt;<em><strong>PAR List </strong></em>&gt; <a href="#" target="_self" class="links">Fillup PAR Form</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
