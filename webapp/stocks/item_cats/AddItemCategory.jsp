...
{
	var txt="";
	var x=document.forms["form1"]["itemCategory"].value;
	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="../menu" target="_top"
				...
				href="../stocks/item-cat?item-cat-action=view-item-cats"
				target="_top" class="links">Item Category List</a> &gt; <em><strong>Add
						Item Category</strong> </em>
			</td>
			<td>&nbsp;</td>
		</tr>
	</table>
					...
					<td><table width="100%" cellspacing="0" frame="box" id="table">
							<tr>
								...
								<td><br /> <input name="itemCategory" type="text"
									class="required" id="itemCategory" /> <br /> <br />
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input name="addBtn" type="submit" class="button"
									id="addBtn" value="ADD" /> <input name="item-cat-action"
									type="hidden" value="save-item-cat" /> <br /> <br />
								</td>
							</tr>
						</table>
					</td>
