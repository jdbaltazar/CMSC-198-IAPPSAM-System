	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="../menu" target="_top"
				...
				target="_top" class="links">Stock Properties</a> &gt;<em><strong>Disposal
						List </strong> </em>&gt; <a
				href="../stocks/disposal?disposal-action=add-disposal"
				target="_self" class="links">Add Disposal</a>
			</td>
			<td>&nbsp;</td>
		</tr>
	</table>
			...
			<tr>
				<td align="center"
					...
					out.println("class=\"tablerow_1\"");%>><form
						id="form1" name="form1" method="post" action="../stocks/disposal">
						<input name="editBtn" type="submit" class="button2" id="editBtn"
							value="Edit&gt;&gt;" /> <input type="hidden" name="disposalID"
							value=<%="" + disposal.getId()%> /> <input type="hidden"
							name="disposal-action" value="edit-disposal" />
					</form>
				</td>
				<td align="center"
					<%if (i % 2 == 0)
					...
					out.println("class=\"tablerow_2\"");%>><%=disposal.getName()%></td>
			</tr>
