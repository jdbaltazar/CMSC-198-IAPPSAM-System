...
{
	var txt="";
	var x=document.forms["form1"]["disposalField"].value;
	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="../menu" target="_top"
				...
				target="_top" class="links">Disposal List</a> &gt; <em><strong>Add
						Disposal</strong> </em></td>
			<td>&nbsp;</td>
		</tr>
	</table>
	<div id="form_table">
			...
			<table width="100%" border="0" cellspacing="0" id="table">
				...
				<tr>
					<td><table width="100%" cellspacing="0" frame="box" id="table">
							<tr>
								<td class="align_right"><br /> Disposal:<br /> <br /></td>
								<td><br /> <input name="disposalField" type="text"
									class="required" id="disposal" /> <br /> <br /></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input name="addBtn" type="submit" class="button"
									id="addBtn" value="ADD" /> <input name="disposal-action"
									type="hidden" value="save-disposal" /> <br /> <br /></td>
							</tr>
						</table></td>
				</tr>
				<tr>
