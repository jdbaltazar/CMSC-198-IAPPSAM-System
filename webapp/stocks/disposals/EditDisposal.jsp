	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="../menu" target="_top"
				...
				href="../stocks/disposal?disposal-action=view-disposals"
				target="_top" class="links">Disposal List</a> &gt; <em><strong>Edit
						Disposal</strong> </em>
			</td>
			<td>&nbsp;</td>
		</tr>
			...
			<table width="100%" border="0" cellspacing="0" id="table">
				...
				<tr>
					<td><table width="100%" cellspacing="0" frame="box" id="table">
							<tr>
								<td class="align_right"><br /> Disposal:<br /> <br />
								</td>
								<td><br /> <input name="disposalField" type="text"
									class="required" id="disposal" value="<%=disposal.getName()%>"
									maxlength="80" /> <input type="hidden" name="disposalID"
									value=<%="" + disposal.getId()%> /> <br /> <br />
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input name="saveBtn" type="submit" class="button"
									id="saveBtn" value="SAVE" /> <input name="disposal-action"
									type="hidden" value="save-edited-disposal" /> <br /> <br />
								</td>
							</tr>
						</table>
					</td>
