...
<title>IAPPSAM::Item Status List</title>
...
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		<td id="navigation"><a href="../../menu" target="_top"
			class="links">Main Menu</a> &gt;<a href="StockProperties.jsp"
			target="_top" class="links">Stock Properties</a> &gt;<em><strong>Item
		Status List </strong></em>&gt; <a href="AddItemStatus.jsp" target="_self"
			class="links">Add Item Status</a></td>
		<td>&nbsp;</td>
	</tr>
</table>
<div id="items_table">
<table width="100%" border="0" cellspacing="0">
	<tr>
		...
		<td width="91%" class="tableheaders_forms">Item Status</td>
	</tr>
	...
	<tr>
		...
		<form id="form1" name="form1" method="post" action="EditItemStatus.do">
		...
		<td align="center"
			<%if (i % 2 == 0)
					out.println("class=\"tablerow_1\"");%>><%=itemStatus.getName()%></td>
	</tr>
