...
<table width="100%" border="0">
  <tr>
    <td width="16%"><table width="100%" frame="below">
      <tr>
        <td style="font-family:Lucida Grande; font-size:20px; font-weight:bold; color:#003300">View Item Status</td>
      </tr>
    </table></td>
    <td width="80%">&nbsp;</td>
    <td width="4%"><form id="form15" name="form15" method="post" action="ViewItemStatus.jsp">
...
<div id="apDiv1">
  <form id="form1" name="form1" method="post" action="">
    <p>
      ...
      <input name="statusField" type="text" id="statusField" disabled="disabled" size="30" />
    </p>
    <p>&nbsp;</p>
    <div id="apDiv2">
