...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="../../menu" target="_top" class="links">Main Menu</a> &gt;<a href="StockProperties.jsp" target="_top" class="links">Stock Properties</a> &gt; <a href="ViewItemStatuses.do" target="_top" class="links">Item Status List</a> &gt; <em><strong>Edit Item Status</strong></em></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="form_table">
