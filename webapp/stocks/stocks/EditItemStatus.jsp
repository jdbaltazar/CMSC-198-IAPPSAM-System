...
<title>IAPPSAm :: Edit Item Status</title>
<style type="text/css">
.menubtn {
	height: 20px;
	width: 416px;
...
<body>
<%
	ItemStatus itemStatus = (ItemStatus) request.getAttribute("itemStatus");
%>
<div id="footer">
...
<table width="100%" border="0">
	<tr>
		...
		<table width="100%" frame="below">
			<tr>
				<td
					style="font-family: Lucida Grande; font-size: 20px; font-weight: bold; color: #003300">Edit
				Item Status</td>
			</tr>
		</table>
		</td>
		...
		<form id="form15" name="form15" method="post"
			action="ViewItemStatuses.do"><input name="backBtn"
...
<div id="apDiv1">
<form id="form1" name="form1" method="post" action="SaveEditedItemStatus.do">
<p><label for="statusField" class="labels">Status:</label> <input
	name="statusField" type="text" id="statusField"
	value="<%=itemStatus.getName()%>" size="30" /> <input type="hidden"
	name="itemStatusID" value=<%="" + itemStatus.getId()%> /></p>
<p>&nbsp;</p>
<div id="apDiv2"><input type="submit" name="updateBtn"
	id="updateBtn" value="Save"
