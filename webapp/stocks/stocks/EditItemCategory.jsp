...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="../../menu" target="_top" class="links">Main Menu</a> &gt;<a href="StockProperties.jsp" target="_top" class="links">Stock Properties</a> &gt; <a href="ViewItemCategories.do" target="_top" class="links">Item Category List</a> &gt; <em><strong>Edit Item Category</strong></em></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="form_table">
