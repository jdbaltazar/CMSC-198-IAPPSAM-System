...
<table width="100%" border="0">
  <tr>
    <td width="17%"><table width="100%" frame="below">
      <tr>
        <td style="font-family:Lucida Grande; font-size:20px; font-weight:bold; color:#003300">Add Item Status</td>
      </tr>
    </table></td>
    <td width="79%">&nbsp;</td>
...
<div id="apDiv1">
  <form id="form1" name="form1" method="post" action="AddStatus.do">
    <p>
      ...
      <input name="statusField" type="text" id="statusField" size="30" />
    </p>
    <p>&nbsp;</p>
    <div id="apDiv2">
