...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="../../menu" target="_top" class="links">Main Menu</a> &gt; <a href="StockProperties.jsp" target="_top" class="links">Stock Properties</a> &gt; <a href="ViewModesOfProcurement.do" target="_top" class="links">Mode of Procurement List</a> &gt; <em><strong>Edit Mode of Procurement</strong></em></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="form_table">
        ...
        <td><table width="100%" cellspacing="0" frame="box" id="table">
          <tr>
            <td class="align_right"><br />
              ...
              <br /></td>
            <td><br />              <input name="modeOfProcurementField" type="text" class="required" id="modeOfProcurement" value="<%=mop.getName()%>" maxlength="80"/>
              <br />
              <br /></td>
          </tr>
          <tr>
