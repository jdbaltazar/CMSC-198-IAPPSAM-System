...
<title>IAPPSAM :: View Item Categories</title>
<style type="text/css">
.menubtn{
	height:20px;
	width:416px;
...
<table width="100%" border="0">
  <tr>
    <td width="15%"><table width="100%" frame="below">
      <tr>
        <td style="font-family:Lucida Grande; font-size:20px; font-weight:bold; color:#003300">Item Categories</td>
      </tr>
    </table></td>
    <td width="81%">&nbsp;</td>
