...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <td id="navigation"><a href="../../menu" target="_top" class="links">Main Menu</a> &gt;<a href="StockProperties.jsp" target="_top" class="links">Stock Properties</a> &gt;<em><strong>Item Category List </strong></em>&gt; <a href="AddItemCategory.jsp" target="_self" class="links">Add Item Category</a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<div id="items_table">
  <table width="100%" border="0" cellspacing="0">
    ...
    <tr>
      ...
      %>
      ><form id="form1" name="form1" method="post" action="EditItemCategory.do">
        <input name="editBtn" type="submit" class="button2" id="editBtn" value="Edit&gt;&gt;" />
      	<input type="hidden" name="itemCategoryID" value=<%="" + itemCategory.getId()%> />
      </form></td>
      <td 
      align="center"
      <%if(i%2==0)
