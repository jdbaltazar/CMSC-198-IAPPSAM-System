...
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		...
		Condition List </strong></em>&gt; <a href="AddItemCondition.jsp" target="_self"
			class="links">Add Item Condition</a></td>
		<td>&nbsp;</td>
	</tr>
</table>
<div id="items_table">
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		...
		<form id="form1" name="form1" method="post" action="EditItemCondition.do">
		<input name="editBtn" type="submit" class="button2" id="editBtn"
			value="Edit&gt;&gt;" /> <input type="hidden" name="itemConditionID"
			value=<%="" + itemCondition.getId()%> /></form>
		</td>
		<td align="center"
			<%if (i % 2 == 0)
