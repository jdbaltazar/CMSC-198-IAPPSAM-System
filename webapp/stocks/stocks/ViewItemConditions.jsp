...
<title>IAPPSAM :: View Item Conditions</title>
<style type="text/css">
.menubtn {
	height: 20px;
	width: 416px;
...
<form id="form1" name="form1" method="post"
	action="AddItemCondition.jsp"><input name="addNewBtn"
...
<table width="100%" frame="box" cellspacing="0">
	...
	<td width="83%"><%=itemCondition.getName()%></td>
	<td width="17%" align="center">
	<form id="form4" name="form4" method="post"
		action="EditItemCondition.do"><input name="editBtn_1"
