...
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		<td id="navigation"><a href="../../menu" target="_top"
			...
			href="ViewItemUnits.do" target="_top" class="links">Item Unit
		List</a> &gt; <em><strong>Edit Item Unit</strong></em></td>
		<td>&nbsp;</td>
	</tr>
</table>
<div id="form_table">
<form id="form1" name="form1" method="post"
	action="SaveEditedItemUnit.do">
<table width="100%" border="0" cellspacing="0" id="table">
	<tr>
		<td class="header_rows"><em>Edit</em></td>
	</tr>
	<tr>
		<td>
		<table width="100%" cellspacing="0" frame="box" id="table">
			...
			<tr>
				...
				<td><input name="saveBtn" type="submit" class="button"
					...
					name="itemUnitID" value=<%="" + itemUnit.getId()%> /> <br />
				<br />
				</td>
			</tr>
		</table>
