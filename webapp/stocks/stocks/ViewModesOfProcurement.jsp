...
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		...
		of Procurement List </strong></em>&gt; <a href="AddModeOfProc.jsp" target="_self"
...
<table width="100%" border="0" cellspacing="0">
	...
	<tr>
		...
		<form id="form1" name="form1" method="post" action="EditModeOfProcurement.do">
		<input name="editBtn" type="submit" class="button2" id="editBtn"
			value="Edit&gt;&gt;" /> <input type="hidden" name="mopID"
			value=<%="" + mode.getId()%> /></form>
		</td>
		<td align="center"
			<%if (i % 2 == 0)
					out.println("class=\"tablerow_1\"");%>><%=mode.getName()%></td>
	</tr>
