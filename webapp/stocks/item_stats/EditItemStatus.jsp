		...
		<tr>
			<td id="navigation"><a href="../menu" target="_top"
				...
				href="../stocks/item-stat?item-stat-action=view-item-stats" target="_top" class="links">Item
					Status List</a> &gt; <em><strong>Edit Item Status</strong> </em></td>
			<td>&nbsp;</td>
		</tr>
	</table>
	<div id="form_table">
					...
					<td><table width="100%" cellspacing="0" frame="box" id="table">
							<tr>
								...
								<td><br /> <input name="itemStatus" type="text"
									class="required" id="itemStatus"
									value="<%=itemStatus.getName()%>" maxlength="50" /> <input
									type="hidden" name="itemStatusID"
									value=<%="" + itemStatus.getId()%> /> <br /> <br /></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
