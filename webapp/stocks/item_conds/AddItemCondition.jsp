	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td id="navigation"><a href="../menu" target="_top"
				...
				href="../stocks/item-cond?item-cond-action=view-item-conds" target="_top" class="links">Item
					Condition List</a> &gt; <em><strong>Add Item Condition</strong> </em></td>
			<td>&nbsp;</td>
		</tr>
	</table>
	<div id="form_table">
					...
					<td><table width="100%" cellspacing="0" frame="box" id="table">
							<tr>
								...
								<td><br /> <input name="itemCondition" type="text"
									class="required" id="itemCondition" /> <br /> <br /></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input name="addBtn" type="submit" class="button"
									id="addBtn" value="ADD" />
									<input
									name="item-cond-action" type="hidden" value="save-item-cond" />
									 <br /> <br /></td>
							</tr>
						</table></td>
				</tr>
