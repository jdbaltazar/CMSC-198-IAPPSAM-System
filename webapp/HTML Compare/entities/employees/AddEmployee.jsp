...
<table width="100%" border="0">
  <tr>
    <td width="13%"><table width="100%" frame="below">
      <tr>
        <td style="font-family:Lucida Grande; font-size:20px; font-weight:bold; color:#003300">Add Employee</td>
      </tr>
    </table></td>
    <td width="83%">&nbsp;</td>
...
<div id="titleDiv">
  <form id="form1" name="form1" method="post" action="">
    ...
    <div id="apDiv11">
      <label for="division3" style="font-family:Lucida Grande; font-size:16px; font-weight:bold">Division:</label>
    ...
    <div id="apDiv12">
      ...
      <select name="office" id="office4">
        ...
        <option>TILC</option>
        <option selected="selected">TLRC</option>
...
<div class="headerLabel" id="apDiv21">Personal Information</div>
<div class="headerLabel" id="apDiv22">Work Information</div>
<div class="headerLabel" id="apDiv23">Contact Information</div>
</body>
</html>