...
<table width="100%" border="0">
  <tr>
    <td width="15%"><table width="100%" frame="below">
      <tr>
        <td style="font-family:Lucida Grande; font-size:20px; font-weight:bold; color:#003300">Division/ Office</td>
      </tr>
    </table></td>
    <td width="81%">&nbsp;</td>
...
<div id="searchEmployeesDiv">
  <form id="form1" name="form1" method="post" action="">
    <label for="searchDivOfficeField" class="labels">Search:</label>
    <input name="searchDivOfficeField" type="text" id="searchDivOfficeField" size="35" />
    <input name="goSearchBtn" type="submit" class="maroon" id="goSearchBtn" value="GO" />
  </form>
</div>
<div id="apDiv1">
  <form id="form2" name="form2" method="post" action="AddDivisionOffice.jsp">
    <input name="addDivOfficeBtn" type="submit" class="maroon" id="addDivOfficeBtn" value="Add Division/Office &gt;&gt;" />
  </form>
</div>
<div id="apDiv10" style="width:100%;">
  <table width="100%" cellspacing="0" frame="box" class="resultTable">
    <tr class="tablerow_1">
      <td width="40%">&nbsp;</td>
      <td width="41%">&nbsp;</td>
      <td width="19%" align="center"><form id="form3" name="form3" method="post" action="ViewDivisionBldgOffice.jsp">
        <input name="viewBtn" type="submit" class="viewbutton" id="viewBtn" value="Edit &gt;&gt;" />
      </form></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
