...
<div id="menu_1">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td colspan="2"><form id="form1" name="form1" method="get" action="items">
		...
		<tr>
			<td colspan="3"><form id="form3" name="form3" method="post" action="stocks">
					<input name="stocksBtn" type="submit" class="menubtn"
							id="stocksBtn" value="Stock Properties" />
					<input type="hidden"
		...
		<tr>
			...
			<td><form id="form6" name="form6" method="post" action="supplier">
		...
		<tr>
			<td><form id="form24" name="form24" method="post" action="division-office">
					<input name="divisionOfficeBtn" type="submit" class="menubtn" id="divisionOfficeBtn" value="Division/Office" />
					<input type="hidden" name="division-office-action" value="view-divisions" />
				</form></td>
			<td><form id="form25" name="form25" method="post" action="division-office">
					<input name="addDivisionBtn" type="submit" class="button2" id="addDivisionBtn" value="Add&gt;&gt;" />
					<input type="hidden" name="division-office-action" value="add-division" />
				</form></td>
		</tr>
		<tr>
			<td><form id="form26" name="form26" method="post" action="/employee">
					<input name="employeeBtn" type="submit" class="menubtn"
							id="employeeBtn" value="Employee" />
					<input type="hidden"
							name="employee-action" value="search-employees" />
				</form></td>
			<td><form id="form27" name="form27" method="post" action="/employee">
		...
		<tr>
			<td colspan="3"><form id="form10" name="form10" method="post"
		...
		<tr>
			<td colspan="3"><form id="form13" name="form13" method="post"
...
<div id="menu_1_forms">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td width="82%"><form id="form14" name="form14" method="post" action="/app">
					<input  name="appBtn2" type="submit" class="menubtn" id="appBtn2" value="Annual Procurement Plan" />
				</form></td>
			<td width="18%"><form id="form15" name="form15" method="post" action="/app?new=app">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td><form id="form8" name="form8" method="post" action="">
				  <input name="icsBtn" type="submit" class="menubtn" id="icsBtn" value="Inventory Custodian Slip" />
			    </form></td>
				<td align="center"><input disabled="disabled" name="addICS" type="submit"
							class="button2" id="addICS" value="Add&gt;&gt;" /></td>
			</tr>
			<tr>
				<td><input disabled="disabled" name="parBtn" type="submit"
							class="menubtn" id="parBtn" value="Property Acknowledgment Report" /></td>
				<td align="center"><input disabled="disabled" name="addPAR" type="submit"
							class="button2" id="addPAR" value="Add&gt;&gt;" /></td>
			</tr>
			<tr>
				<td><input disabled="disabled" name="iirupBtn" type="submit"
							class="menubtn" id="iirupBtn" value="Inventory and Inspection Report of Unserviceable Property" /></td>
				<td align="center"><input disabled="disabled" name="addIIRUP" type="submit"
							class="button2" id="addIIRUP" value="Add&gt;&gt;" /></td>
			</tr>
			<tr>
				<td><input disabled="disabled" name="ptrpaBtn" type="submit"
							class="menubtn" id="ptrpaBtn" value="Proof of Transfer and Receipt of Property Accountability" /></td>
				<td align="center"><input disabled="disabled" name="addPTRPA" type="submit"
							class="button2" id="addPTRPA" value="Add&gt;&gt;" /></td>
			</tr>
			<tr>
				<td><input disabled="disabled" name="wmrBtn" type="submit"
							class="menubtn" id="wmrBtn" value="Waste Materials Report" /></td>
				<td align="center"><input disabled="disabled" name="addWMR" type="submit"
							class="button2" id="addWMR" value="Add&gt;&gt;" /></td>
			</tr>
	  </table>
</div>
<div id="menu_account">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td colspan="2"><form id="form10" name="form10" method="post"
						action="accounts/create_account.jsp"><input name="createAcctBtn" type="submit" class="menubtn"
							id="createAcctBtn" value="Create New" /></form></td>
    </tr>
    <tr>
      <td width="78%"><form id="form11" name="form11" method="post"
						action=""><input name="viewAcctsBtn" type="submit" class="menubtn"
							id="viewAcctsBtn" value="View Accounts" /></form></td>
      <td width="22%"><form id="form29" name="form29" method="post" action=""><input name="myAcctBtn" type="submit" class="button2"
							id="myAcctBtn" value="My Account" /></form></td>
    </tr>
  </table>
</div>
<div id="menu_stocks">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="78%"><form id="form1" name="form1" method="get" action="items"><input name="itemBtn" type="submit" class="menubtn" id="itemBtn"
							value="Item" /></form></td>
      <td width="22%"><form id="form28" name="form28" method="post"
						action="items"><input name="addItemBtn" type="submit" class="button2"
							id="addItemBtn" value="Add&gt;&gt;" /></form></td>
    </tr>
    <tr>
      <td colspan="2"><form id="form3" name="form3" method="post" action="stocks"><input type="hidden"
							name="stock-properties-action" value="view-stock-properties" />
<input name="stocksBtn" type="submit" class="menubtn"
							id="stocksBtn" value="Stock Properties" /></form></td>
    </tr>
  </table>
</div>
	<div id="menu_database">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td class="main_menu_header">Database</td>
        </tr>
	    <tr>
	      <td><form id="form12" name="form12" method="post" action=""><input name="viewSysLog" type="submit" class="menubtn"
							id="viewSysLog" value="View System Log" /></form></td>
        </tr>
	    <tr>
	      <td><form id="form13" name="form13" method="post"
						action="database/backup.sql"><input name="backup" type="submit" class="menubtn" id="backup"
							value="Backup" /></form></td>
        </tr>
      </table>
	</div>
<div id="menu_settings">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="27%" rowspan="4" class="labels">Records</td>
      <td width="56%"><form id="form4" name="form4" method="post"
						action="building"><input
							name="building-action" type="hidden" value="view-buildings" /><input name="buildingBtn" type="submit" class="menubtn"
							id="buildingBtn" value="Building" /></form></td>
      <td width="17%"><form id="form7" name="form7" method="post"
						action="building"><input
							name="building-action" type="hidden" value="add-building" /><input name="addBuilding" type="submit" class="button2"
							id="addBuilding" value="Add&gt;&gt;" /></form></td>
    </tr>
    <tr>
      <td><form id="form5" name="form5" method="post" action="supplier"><input type="hidden"
							name="supplier-action" value="view-suppliers" /><input name="supplierBtn" type="submit" class="menubtn"
							id="supplierBtn" value="Supplier" /></form></td>
      <td><form id="form6" name="form6" method="post" action="supplier"><input type="hidden"
							name="supplier-action" value="new-supplier" /><input name="addSupplierBtn" type="submit" class="button2"
							id="addSupplierBtn" value="Add&gt;&gt;" /></form></td>
    </tr>
    <tr>
      <td><form id="form24" name="form24" method="post"
						action="division-office">
	  <input type="hidden"
							name="division-office-action" value="view-divisions" /><input name="divisionOfficeBtn" type="submit" class="menubtn"
							id="divisionOfficeBtn" value="Division/Office" /></form></td>
      <td><form id="form25" name="form25" method="post"
						action="division-office">
	  <input type="hidden"
							name="division-office-action" value="add-division" /><input name="addDivisionBtn" type="submit" class="button2"
							id="addDivisionBtn" value="Add&gt;&gt;" /></form></td>
    </tr>
    <tr>
      <td><form id="form26" name="form26" method="get"
						action="/entities/employees/search_employee.do"><input name="employeeBtn" type="submit" class="menubtn"
							id="employeeBtn" value="Employee" /></form></td>
      <td>					<form id="form27" name="form27" method="post"
						action="entities/employees/add_employee.jsp">
<input name="addEmployeeBtn" type="submit" class="button2"
							id="addEmployeeBtn" value="Add&gt;&gt;" /></form></td>
    </tr>
    <tr>
    <td>
    &nbsp;
