...
<div id="menu_1">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="80%"><form id="form1" name="form1" method="get" action="items">
      <input name="itemBtn" type="submit" class="menubtn" id="itemBtn"
							value="Item" /></form> </td>
      <td width="20%"><form id="form28" name="form28" method="post"
						action="items">
      <input name="addItemBtn" type="submit" class="button2"
							id="addItemBtn" value="Add&gt;&gt;" /></form></td>
    </tr>
    <tr>
      <td colspan="2"><form id="form3" name="form3" method="post" action="stocks">
        <input type="hidden"
...
<div id="menu_2">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td colspan="2"><form id="form16" name="form16" method="post" action="/pr">
        <input name="prBtn" type="submit" class="menubtn" id="prBtn"
							value="Purchase Request" />
      </form></td>
      <td><form id="form17" name="form17" method="post" action="/pr?new=pr">
