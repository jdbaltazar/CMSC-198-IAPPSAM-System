...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<form id="form3" name="form3" method="post" action=""><input
			name="appBtn" type="submit" class="menubtn" id="appBtn"
			value="Annual Procurement Plan" /></form>
		</td>
	</tr>
	<tr>
		<td colspan="3">
		<form id="form4" name="form4" method="post" action=""><input
			name="inventory" type="submit" class="menubtn" id="inventory"
	...
	<tr>
		...
		<form id="form7" name="form7" method="post"
			...
			name="stockProperties" type="submit" class="menubtn"
			id="stockProperties" value="Stock Properties" /></form>
		</td>
	</tr>
	<tr>
		<td width="54%">
		...
		<input name="supplierBtn" type="submit" class="menubtn"
			...
			name="supplier-action" value="view-suppliers" /></form>
		</td>
		<td width="18%">
		...
		<input name="addSupplierBtn" type="submit" class="button2"
			...
			name="supplier-action" value="new-supplier" /></form>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<form id="form8" name="form8" method="post"
			action="entities/building/ViewBuildings.do"><input
			name="buildingBtn" type="submit" class="menubtn" id="buildingBtn"
			value="Building" /></form>
		</td>
		<td>
		<form id="form9" name="form9" method="post"
			action="entities/building/AddBuilding.do"><input
			name="addBuildingBtn" type="submit" class="button2"
			id="addBuildingBtn" value="Add&gt;&gt;" /></form>
		</td>
	</tr>
	<tr>
		<td>
		<form id="form24" name="form24" method="post"
			...
			name="divisionOfficeBtn" type="submit" class="menubtn"
			id="divisionOfficeBtn" value="Division/Office" /></form>
		</td>
		<td>
		<form id="form25" name="form25" method="post"
			action="entities/division/AddDivision.jsp"><input
			name="addDivisionBtn" type="submit" class="button2"
			id="addDivisionBtn" value="Add&gt;&gt;" /></form>
		</td>
	</tr>
	<tr>
		<td>
		...
		<form id="form27" name="form27" method="post"
			action="entities/employees/add_employee.jsp"><input
			name="addEmployeeBtn" type="submit" class="button2"
			id="addEmployeeBtn" value="Add&gt;&gt;" /></form>
		</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	...
	<tr>
		...
		<form id="form12" name="form12" method="post" action=""><input
			name="viewSysLog" type="submit" class="menubtn" id="viewSysLog"
	...
	<tr>
		...
		<form id="form13" name="form13" method="post"
			action="database/backup.sql"><input name="backup"
			type="submit" class="menubtn" id="backup" value="Backup" /></form>
		</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td width="82%">
		<form id="form14" name="form14" method="post" action=""><input
			name="appBtn2" type="submit" class="menubtn" id="appBtn2"
			value="Annual Procurement Plan" /></form>
		</td>
		<td width="18%">
		<form id="form15" name="form15" method="post" action=""><input
			name="addAppBtn" type="submit" class="button2" id="addAppBtn"
			value="Add&gt;&gt;" /></form>
		</td>
	</tr>
	<tr>
		<td>
		<form id="form16" name="form16" method="post" action="/pr"><input
			name="prBtn" type="submit" class="menubtn" id="prBtn"
			value="Purchase Request" /></form>
		</td>
		<td align="center">
	...
	<tr>
		<td>
		<form id="form18" name="form18" method="post" action=""><input
			name="purchaseOrder" type="submit" class="menubtn" id="purchaseOrder"
	...
	<tr>
		<td>
		<form id="form20" name="form20" method="post" action=""><input
			name="risBtn" type="submit" class="menubtn" id="risBtn"
			value="Requisition &amp; Issue Slip" /></form>
		</td>
		<td align="center">
		<form id="form21" name="form21" method="post" action=""><input
			name="addBtn" type="submit" class="button2" id="addBtn"
			value="Add&gt;&gt;" /></form>
		</td>
	</tr>
	<tr>
		<td>
		<form id="form22" name="form22" method="post" action=""><input
			name="ieBtn" type="submit" class="menubtn" id="ieBtn"
			value="Inventory of Equipment" /></form>
		</td>
		<td align="center">
		<form id="form23" name="form23" method="post" action=""><input
			name="addIE" type="submit" class="button2" id="addIE"
			value="Add&gt;&gt;" /></form>
		</td>
	</tr>
	<tr>
