...
.maroon:hover {
	font-weight: bold; r /*	background:#EEE0E5;;*/ border-left : 1px solid
	#7B1113;
...
<body>
	<div id="footer">
		<table width="100%" frame="above" bordercolor="#333333"
			...
			<tr>
				<td width="50%">Copyright � 2011 All Rights Reserved</td>
				<td width="50%">&nbsp;</td>
			</tr>
		</table>
	</div>
	...
	<div id="createNewAcctDiv">
		<form id="form1" name="form1" method="post"
			action="accounts/CreateAccount.jsp">
			<input name="createNewAcctBtn" type="submit" class="button"
				id="createNewAcctBtn" value="Create New" />
		</form>
	</div>
	<div id="viewAcctDiv">
		<form id="viewAcct" name="viewAcctForm" method="post"
			action="accounts/ViewAccounts.do">
			<input name="viewAcctsBtn" type="submit" class="button"
				id="viewAcctsBtn" value="View Accounts" />
		</form>
	</div>
	<div id="viewSysLogdiv">
		<form id="form2" name="form2" method="post"
			action="database/ViewSystemLog.jsp">
			<input name="viewSysLogBtn" type="submit" class="button"
				id="viewSysLogBtn" value="View System Log" />
		</form>
	</div>
	<div id="backupDiv">
	...
	<div id="recoverdbDiv">
		<form id="form4" name="form4" method="post" action="">
			<input name="recoverdbBtn" type="submit" class="button"
				id="recoverdbBtn" value="Recover" />
		</form>
	</div>
	<div id="itemDiv">
		<form id="form5" name="form5" method="post"
			action="items/SearchAllItems.do">
			<input name="itemBtn" type="submit" class="button" id="itemBtn"
				value="Item" />
		</form>
	</div>
	<div id="appDiv">
		<form id="form6" name="form6" method="post" action="">
			<input name="appBtn" type="submit" class="button" id="appBtn"
				value="Annual Procurement Plan" disabled="disabled" />
		</form>
	</div>
	<div id="inventoryDiv">
		<form id="form7" name="form7" method="post" action="">
			<input name="inventoryBtn" type="submit" class="button"
				id="inventoryBtn" value="Inventory" />
		</form>
	</div>
	<div id="fillupDiv">
		<form id="form8" name="form8" method="post"
			action="forms/FormsMenuPage.jsp">
			<input name="fillupBtn" type="submit" class="button" id="fillupBtn"
				value="Fillup" />
		</form>
	</div>
	<div id="viewFormDiv">
		<form id="form9" name="form9" method="post"
			action="forms/ViewFormsMenuPage.jsp">
			<input name="viewFormBtn" type="submit" class="button"
				id="viewFormBtn" value="View" />
		</form>
	</div>
	<div id="apDiv3">
		<form id="form10" name="form10" method="post"
			action="stocks/stocks/StockProperties.jsp">
			<input name="stockPropBtn" type="submit" class="button2"
				id="stockPropBtn" value="Stock Properties" />
		</form>
	</div>
	<div id="divisionOfficeDiv">
		<form id="form13" name="form13" method="post"
			action="entities/division/SearchDivisions.do">
			<input name="divisionOfficeBtn" type="submit" class="button2"
				id="divisionOfficeBtn" value="Division/Office" />
		</form>
	</div>
	<div id="employeeDiv">
		<form id="form14" name="form14" method="post"
			action="entities/employees/SearchEmployee.do">
			<input name="employeeBtn" type="submit" class="button2"
				id="employeeBtn" value="Employees" />
		</form>
	</div>
	...
	<div id="apDiv2">
		<form id="logout" name="form12" method="post" action="logout">
			<input name="logoutBtn" type="submit" class="maroon" id="logoutBtn"
				value="Logout" />
		</form>
	</div>
	<p>&nbsp;</p>
	...
	<div id="supplierDiv">
		<form id="form11" name="form11" method="post"
			action="entities/supplier/SearchSuppliers.do">
			<input name="supplierBtn" type="submit" class="button2"
	...
	<div id="apDiv6">
		<div id="apDiv7">
			<a href="help.html" title="IAPPSAM Help" target="_blank" class="link">Help</a>
		</div>
	</div>
</body>
</html>
