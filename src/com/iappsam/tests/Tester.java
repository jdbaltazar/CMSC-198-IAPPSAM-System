	...
	public static void main(String[] args) {
		try {
			...
			ItemManager iManager = new ItemManagerSession();
			 ...
			 Person person = new Person("dcfvgbhn", "nnnnnnnnnnnnnnnnnnnnnnnn");
...
//			 Building building = new Building("DFDFDF DFdfd",
//			 "UPTAC Compund");
...
//			//ItemCondition
//			ItemCondition itemCondition = new ItemCondition("GOOD CONDITION");
