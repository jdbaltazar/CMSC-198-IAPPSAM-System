...
public class WMR {
	...
	public WMR(String placeOfStorage, int divisionOfficeID, Date date, int propertyOfficerSignatoryID, int approvedBySignatoryID, int propertyInspectorSignatoryID, int witnessToSignatoryID) {
		super();
	...
	public WMR(int divisionOfficeID, Date date, int propertyOfficerSignatoryID, int approvedBySignatoryID, int propertyInspectorSignatoryID, int witnessToSignatoryID) {
		super();
		this.divisionOfficeID = divisionOfficeID;
		this.date = date;
		this.propertyOfficerSignatoryID = propertyOfficerSignatoryID;
