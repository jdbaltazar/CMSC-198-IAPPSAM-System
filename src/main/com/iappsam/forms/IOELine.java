...
@Entity
@Table(name = "IE_Line")
public class IOELine implements Serializable{
	...
	public IOELine(int itemID, int quantity, int employeeID, String howAcquired, String remarks, int ieID) {
		super();
		this.itemID = itemID;
	...
	public IOELine(int itemID, int quantity, int employeeID, String howAcquired, int ieID) {
		super();
		this.itemID = itemID;
		this.quantity = quantity;
		this.employeeID = employeeID;
