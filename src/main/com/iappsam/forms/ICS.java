...
public class ICS {
	...
	public ICS(String icsNumber, String purpose, int supplierID, int receivedBySignatoryID, int receviedFromSignatoryID) {
		super();
	...
	public ICS(int supplierID, int receivedBySignatoryID, int receviedFromSignatoryID) {
		super();
		setSupplierID(supplierID);
		setReceivedBySignatoryID(receivedBySignatoryID);
		setReceviedFromSignatoryID(receviedFromSignatoryID);
